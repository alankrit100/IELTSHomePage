...
export function HeroSection() {
  const scrollToContact = () => {
    // Note: In a real Next.js/React app, use a dedicated Router or Context for contact sections
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden py-20">
      ...
      {/* 2. Floating Animated Background Blobs (Kept and adjusted) */}
      <div className="absolute inset-0">
        ...
        <div className="absolute top-40 right-10 w-72 h-72 bg-purple-400 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-pulse animation-delay-2000" />
        <div className="absolute -bottom-8 left-20 w-72 h-72 bg-indigo-400 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-pulse animation-delay-4000" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="grid grid-cols-3 gap-6 animate-fade-in-up-5">
              {stats.map((stat, index) => (
                <Card 
                  key={index} 
                  className="p-6 bg-white/95 backdrop-blur-md border border-blue-200 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 cursor-pointer"
                >
          ...
          <div className="relative hidden lg:block animate-fade-in-up-3">
            <div className="relative z-10 p-4 bg-white rounded-3xl shadow-3xl"> 
              <img
                src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=800&q=80"
                alt="Students studying for IELTS"
                className="rounded-2xl shadow-inner w-full h-[550px] object-cover"
              />
              
              {/* Floating Cards with subtle animation */}
              <Card className="absolute -top-10 -left-10 p-5 bg-white/95 backdrop-blur-lg shadow-2xl animate-float-1 border border-gray-100">
              ...
              <Card className="absolute -bottom-10 -right-10 p-5 bg-white/95 backdrop-blur-lg shadow-2xl animate-float-2 border border-gray-100">
                <div className="flex items-center space-x-3">
...
// NOTE: You must define the custom animations (e.g., animate-fade-in-up-1, animate-float-1, etc.)
// in your tailwind.config.js and globals.css file for these classes to work.